 ...
 * @date 2019/2/15
 */
class RegisteredActivity : BaseActivity(), RegisteredMvpView {
    override fun getVCodeSuccess() {
        tv_vcode.start()
    }

    override fun registeredSuccess() {
//        PersonalInformationActivity.startAfterRegister(mContext)
    ...
    companion object {
        ...
        fun start(activity: Activity, requestCode: Int) {
            val starter = Intent(activity, RegisteredActivity::class.java)
    ...
    private fun initView() {
        ...
        tv_registered.clickWithTrigger {
            ...
            presenter.register(tv_area_code.getStr(), et_login_phone.getStr(), et_login_mailbox.getStr(), et_vcode.getStr(), et_password.getStr(), et_confirm_password.getStr(), registeredType == TYPE_PHONE_REGISTER)
        }
