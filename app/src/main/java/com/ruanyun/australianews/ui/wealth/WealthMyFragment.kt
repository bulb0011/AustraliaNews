 ...
 * @date 2020/3/28
 */
class WealthMyFragment : BaseFragment() {
    ...
    private fun initView() {
        ...
        tv_release.clickWithTrigger { if(isLoginToActivity) WealthMyReleaseListActivity.start(mContext) }
        tv_collection.clickWithTrigger { if(isLoginToActivity) WealthMyCollectListActivity.start(mContext) }
        tv_footprint.clickWithTrigger { if(isLoginToActivity) WealthMyBrowseListActivity.start(mContext) }
    }
